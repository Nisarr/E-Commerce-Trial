...
export const FeaturedCategories: React.FC = () => {
  ...
  const displayCategories = categories.length > 0 ? categories : [
    { id: '1', name: 'Diapers', slug: 'diapers', image: '/catagory/diapers.png', parentId: null },
    { id: '2', name: 'Bath', slug: 'bath', image: '/catagory/bath.png', parentId: null },
    { id: '3', name: 'Bottles', slug: 'bottles', image: '/catagory/bottles.png', parentId: null },
    { id: '4', name: 'Toys', slug: 'toys', image: '/catagory/toys.png', parentId: null },
    { id: '5', name: 'Clothes', slug: 'clothes', image: '/catagory/clothes.png', parentId: null },
    { id: '6', name: 'Strollers', slug: 'strollers', image: '/catagory/strollers.png', parentId: null },
    { id: '7', name: 'Feeding', slug: 'feeding', image: '/catagory/feeding.png', parentId: null },
    { id: '8', name: 'Bedding', slug: 'bedding', image: '/catagory/bedding.png', parentId: null },
    { id: '9', name: 'Safety', slug: 'safety', image: '/catagory/safety.png', parentId: null },
    { id: '10', name: 'Health', slug: 'health', image: '/catagory/health.png', parentId: null },
    { id: '11', name: 'Gifting', slug: 'gifting', image: '/catagory/gifting.png', parentId: null },
    { id: '12', name: 'Gear', slug: 'gear', image: '/catagory/gear.png', parentId: null },
  ];
