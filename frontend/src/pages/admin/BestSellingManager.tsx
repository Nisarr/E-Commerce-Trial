...
export const BestSellingManager: React.FC = () => {
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-3xl font-black text-primary tracking-tight mb-2">Best Selling Products</h2>
          <p className="text-muted font-medium">Manage products featured in the "Best Sellers" section.</p>
        </div>
        <div className="flex gap-4">
          <button 
            onClick={handleAutoSync}
            disabled={syncing}
            className="flex items-center gap-2 px-6 py-3 bg-indigo-500 text-white rounded-2xl font-black uppercase tracking-widest text-xs transition-all shadow-lg shadow-indigo-200 hover:bg-indigo-600 disabled:opacity-50"
          >
      ...
      <div className="bg-indigo-50/50 rounded-3xl p-6 border-2 border-dashed border-indigo-200 flex items-center gap-6">
        ...
        <div>
          ...
          <p className="text-xs text-muted font-medium mt-1">
            "Auto Calculate" picks the <span className="font-bold text-indigo-600">8 products with the highest sales counts</span>. 
            You can manually "Force" any product to be a Best Seller regardless of its sales data.
          </p>
        </div>
      </div>
    </div>
